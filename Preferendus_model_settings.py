...
def settings():
    ...
    """ 
    wb = xw.Book('Preferendus_model.xlsm')
    wks = xw.sheets
    ...
    black_box_output_optimum = "G6" # First (numerical) value to print the variable outcomes (no headers)

    # Give the starting cell of elements in 'preferendus tool' tab (the first cell)
    number_of_runs = "H46" # Cell value that reports the number of runs to be performed
    
    # Give the starting cell of elements in 'multiple runs tool' tab (the first cell)
    multiple_runs_print = "A11" # First (numerical) value to print the variable outcomes (no headers)
    
    # Give the starting cell of elements in the 'assistance tab' tab (the first cell)
    ...
    start_functions_categorical = "C400" # First (numerical) value of variable functions table for the categorical objectives (no headers or x1)
    start_functions_categorical_new = "C400" # First (numerical) value of variable functions table for the categorical objectives (no headers or x1)
    start_functions_balance = "D236" # First (numerical) value of variable functions table for the saldo objective (no headers or x1)
    start_categorical_balance_sum = "C352" # First (numerical) value of sum of the categoric preferendus calculation table for the optimalisation (no headers or x1)
    start_stakeholder_weights = "B382" # First (numerical) value of stakeholder weights table (no headers or x1)
    ...
    return (preference_curves_ws, preferendus_tool_ws, multiple_runs_tool_ws, folder_location, number_of_runs, multiple_runs_print, black_box_output_optimum, 
            ...
            scenario_delta_balance_list, categorical_balance_sum_list, surface_list, black_box_bounds_list, options, start_plot)
